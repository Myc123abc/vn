...
void FrameBuffer::upload(ID3D12GraphicsCommandList* cmd, std::span<Vertex> vertices, std::span<uint16_t> indices, std::span<ShapeProperty> shape_properties) noexcept
{
