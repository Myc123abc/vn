...
void Pipeline::set_descriptors(ID3D12GraphicsCommandList1* cmd, std::vector<std::pair<std::string_view, D3D12_GPU_DESCRIPTOR_HANDLE>> const& handles) const noexcept
{
